...
const FeatureCard = ({ icon, title, content, index }) => (
  <div className={`flex flex-row p-6 rounded-[20px] justify-items-start ${index !== features.length - 1 ? "mb-6" : "mb-0"} feature-card`}>
...
const Business = () =>  (
  <section id="features" className={layout.section}>
    ...
    <div className={`${layout.sectionImg} flex-col flex-1`}>
